    ...
    <section class="section">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('add.general') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <table class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{ url('executive-member') }}/{{ $detail->id }}">
