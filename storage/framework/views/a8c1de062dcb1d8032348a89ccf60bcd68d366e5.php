                    ...
                    <div class="card-body">
                        <div class="table-responsive">
							<table id="example" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                ...
                                <tbody>
                                <?php $__currentLoopData = $operationAreas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <tr>
                                         <td><?php echo e($index + 1); ?></td>
                                         <td><?php echo e($area->name); ?></td>
                                         <td>
                                         <form action="<?php echo e(route('areaofoperation.delete', $area->id)); ?>" method="POST">
                                             <?php echo csrf_field(); ?>
