							...
							<table class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($detail->cv): ?>
                                                <a href="<?php echo e(asset('storage/' . $detail->cv)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                N/A
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($detail->police_verficaton): ?>
                                                <a href="<?php echo e(asset('storage/' . $detail->police_verficaton)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                            N/A
                                            <?php endif; ?>
                                        </td>
