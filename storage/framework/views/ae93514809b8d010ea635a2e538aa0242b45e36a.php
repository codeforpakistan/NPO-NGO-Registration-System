...
<hr>
					...
					<div class="row">
						<div class="col-12 text-center mt-3">
							<button id="reverse_btn_dd" class="btn btn-danger" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>">Reverse Application</button>
							<button id="submit_btn_dd" class="btn btn-primary" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>">Forward Application</button>
					</div>
...
<?php endif; ?>
		...
		<script>
			$(document).ready(function () {
				$('#submit_btn_dd').click(function (e) {
    ...
    $.ajax({
        url: "<?php echo e(route('forward.app.dd')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        success: function (response) {
            if (response.success) {
                Swal.fire({
                    title: "Success!",
                    text: "Application has been forwarded successfully.",
                    icon: "success",
                    timer: 2000,
                    showConfirmButton: false
                }).then(() => {
                    window.location.href = "<?php echo e(route('app_summary_dd')); ?>";
                });
            } else {
                Swal.fire({
                    title: "Error!",
...
$("#reverse_btn_dd").click(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: "<?php echo e(route('reverse.app.dd')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
