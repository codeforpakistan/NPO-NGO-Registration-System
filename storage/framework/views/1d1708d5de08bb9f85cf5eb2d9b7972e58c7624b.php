    ...
    <section class="section">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" style="margin-top: 80px;">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(url('aim-objective/add')); ?>"
                    method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
							<table id="example" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
                                ...
                                <tbody>
                                <?php $__currentLoopData = $listofaims; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $aims): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <tr>
                                         <td><?php echo e($index + 1); ?></td>
                                         <td><?php echo e($aims->name); ?></td>
                                         <td>
                                         <form action="<?php echo e(route('aims.delete', $aims->id)); ?>" method="POST">
                                             <?php echo csrf_field(); ?>
