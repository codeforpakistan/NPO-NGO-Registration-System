                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($operation->future_plan_file): ?>
                                                <a href="<?php echo e(asset('storage/' . $operation->future_plan_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No file
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php if($operation->plan_operation_file): ?>
                                                <a href="<?php echo e(asset('storage/' . $operation->plan_operation_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No file
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if($operation->progress_report_file): ?>
                                                <a href="<?php echo e(asset('storage/' . $operation->progress_report_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No file
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php if($operation->first_meeting_file): ?>
                                                <a href="<?php echo e(asset('storage/' . $operation->first_meeting_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No file
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php if($operation->last_meeting_file): ?>
                                                <a href="<?php echo e(asset('storage/' . $operation->last_meeting_file)); ?>" target="_blank">View File</a>
                                            <?php else: ?>
                                                No file
                                            <?php endif; ?>
                                        </td>
