...
<div class="app-content">
    ...
    <section class="section">
        ...
        <div class="page-header pt-0">
            <h4 class="page-title font-weight-bold">Application </h4>
            <ol class="breadcrumb">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" style="margin-top: 80px;">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="font-weight-bold">Application</h4>
                </div>
                <div class="card-body">
				
					<div class="container">
						<div class="logo">
							<img src="<?php echo e(asset('images/logo.png')); ?>" alt="Agency Logo">
						</div>
						<h2>Application</h2>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2 3/resources/views/application.blade.php ENDPATH**/ ?>