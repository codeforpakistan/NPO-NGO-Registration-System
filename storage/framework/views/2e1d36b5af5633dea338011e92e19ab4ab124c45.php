...
<div class="modal fade" id="basicInfoModal" tabindex="-1" role="dialog" aria-labelledby="basicInfoModalLabel" aria-hidden="true">
    ...
    <section class="section">
        ...
        <div class="page-header pt-0">
            <h4 class="page-title font-weight-bold">Rejected Application List</h4>
            <ol class="breadcrumb">
                                    ...
                                    <tr>
                                       ...
                                       <!-- <td>
                                        ...
                                        <td class="text-center align-middle">
                                            <?php if($record->reject==1): ?>
                                            <!--<a href="<?php echo e(url('application/district/view')); ?>/<?php echo e($record->id); ?>"> -->
                                                <button
