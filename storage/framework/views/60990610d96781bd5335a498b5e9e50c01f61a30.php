...
<hr>
					...
					<div class="row">
						<div class="col-12 text-center mt-3">
							<button id="reverse_btn_district" class="btn btn-danger" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>">Reverse Application</button>
							<button id="submit_btn_district" class="btn btn-primary" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>">Forward Application</button>
					</div>
