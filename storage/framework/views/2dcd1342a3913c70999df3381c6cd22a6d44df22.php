                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
                            <span>
                                <img src="<?php echo e(asset('assets/img/avatar/user_icon.jpg')); ?>" alt="profile-user"
            ...
            <aside class="app-sidebar">
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="nav-link pl-1 pr-1 leading-none ">
                            <img src="<?php echo e(asset('assets/img/avatar/KP-Logo.png')); ?>" alt="user-img"
                ...
                <ul class="side-menu">
                    ...
                    <?php if($role_id == 2): ?>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('do_forwarded_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                    ...
                    <?php if($role_id == 3): ?>
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('app_summary_ad')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Applications</span>
                            </a>
                        </li>
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('ad_forwarded_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Forwarded Applications</span>
                            </a>
                        </li>
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('ad_accepted_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('ad_certificate_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                    ...
                    <?php if($role_id == 4): ?>
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('app_summary_dd')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Applications</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('dd_forwarded_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Forwarded Applications</span>
                            </a>
                        </li>
                    ...
                    <li>
                            <a class="side-menu__item" href="<?php echo e(url('dg_accepted_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Accepted Applications</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('dg_rejected_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(url('dg_certificate_apps_list')); ?>">
                                <i class="side-menu__icon fe fe-grid"></i>
                                <span class="side-menu__label">Certificates</span>
                            </a>
                        </li>
                    ...
                    <?php if($role_id == 1): ?>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="<?php echo e(url('districts')); ?>">Add Districts</a></li>
                    ...
                    <?php if(session()->has('id') && !in_array($role_id, [1, 2, 3,4,5])): ?>
                        <li>
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="<?php echo e(url('summary')); ?>">Application List</a></li>
                                <li><a class="slide-item" href="<?php echo e(url('ngo_forwarded_apps')); ?>">Submitted Application</a></li>
                            </ul>
                        </li>
