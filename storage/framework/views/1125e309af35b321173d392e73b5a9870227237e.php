    ...
    <section class="section">
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" style="margin-top: 80px;">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(url('basic-information/add')); ?>" method="POST" type="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2 3/resources/views/basic-information.blade.php ENDPATH**/ ?>