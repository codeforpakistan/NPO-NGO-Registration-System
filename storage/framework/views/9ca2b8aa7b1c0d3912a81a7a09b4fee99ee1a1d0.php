...
<html lang="en">
	<head>
		...
		<link href="<?php echo e(asset('assets/css/boxed')); ?>" rel="stylesheet" />
	...
	<body class="app ">
			...
			<div class="main-wrapper" >
					...
					<nav class="navbar navbar-expand-lg main-navbar">
						<div class="container">
							...
							<a class="header-brand" href="index.html">
								<img src="<?php echo e(asset('assets/img/brand/logo-white.png')); ?>" class="header-brand-img" alt="Splite-Admin  logo">
							</a>
							...
							<ul class="navbar-nav navbar-right">
								<li class="dropdown dropdown-list-toggle d-none d-lg-block "><a href="#" data-toggle="dropdown" class="nav-link  nav-link-lg "><i class=" fa fa-flag-o "></i></a>
									<div class="dropdown-menu dropdown-menu-lg  dropdown-menu-right">
										<a href="#" class="dropdown-item d-flex align-items-center">
											<img src="<?php echo e(asset('assets/img/flags/french_flag.jpg')); ?>" alt="flag-img" class=" flag-sm mr-3 align-self-center">
											<div>
												<strong>French</strong>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex align-items-center">
											<img src="<?php echo e(asset('assets/img/flags/germany_flag.jpg')); ?>" alt="flag-img" class=" flag-sm mr-3 align-self-center">
											<div>
												<strong>Germany</strong>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex align-items-center">
											<img src="<?php echo e(asset('assets/img/flags/italy_flag.jpg')); ?>" alt="flag-img" class=" flag-sm  mr-3 align-self-center">
											<div>
												<strong>Italy</strong>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex align-items-center">
											<img src="<?php echo e(asset('assets/img/flags/russia_flag.jpg')); ?>" alt="flag-img" class=" flag-sm mr-3 align-self-center">
											<div>
												<strong>Russia</strong>
											</div>
										</a>
										<a href="#" class="dropdown-item d-flex align-items-center">
											<img src="<?php echo e(asset('assets/img/flags/spain_flag.jpg')); ?>" alt="flag-img" class=" flag-sm mr-3 align-self-center">
											<div>
												<strong>Spain</strong>
											</div>
										</a>
									...
									<div class="dropdown-menu dropdown-list dropdown-menu-right">
										...
										<div class="dropdown-list-content">
											<a href="#" class="dropdown-item dropdown-item-unread">
												<img alt="image" src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" class="rounded-circle dropdown-item-img">
											...
											<a href="#" class="dropdown-item dropdown-item-unread">
												<img alt="image" src="<?php echo e(asset('assets/img/avatar/avatar-2.jpeg')); ?>" class="rounded-circle dropdown-item-img">
												<div class="dropdown-item-desc">
													<div class="dropdownmsg d-flex">
														<div class="">
															<b>Jonathan North</b>
											...
											<a href="#" class="dropdown-item">
												<img alt="image" src="<?php echo e(asset('assets/img/avatar/avatar-4.jpeg')); ?>" class="rounded-circle dropdown-item-img">
												<div class="dropdown-item-desc">
													<div class="dropdownmsg d-flex">
														<div class="">
															<b>Victor Taylor</b>
											...
											<a href="#" class="dropdown-item">
												<img alt="image" src="<?php echo e(asset('assets/img/avatar/avatar-5.jpeg')); ?>" class="rounded-circle dropdown-item-img">
												<div class="dropdown-item-desc">
													<div class="dropdownmsg d-flex">
														<div class="">
															<b>Sam	Lyman</b>
								...
								<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
									...
									<span><img src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
									</a>
				...
				<div class="popup-box chat-popup" id="qnimate">
					<div class="popup-head">
						<div class="popup-head-left pull-left"><img src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" alt="iamgurdeeposahan" class="mr-2"> Alica Nestle</div>
					...
					<div class="popup-messages">
						<div class="direct-chat-messages">
							...
							<div class="direct-chat-msg">
								...
								<img class="direct-chat-img" src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" alt="message user image">
							...
							<div class="direct-chat-msg right">
								...
								<img class="direct-chat-img" src="<?php echo e(asset('assets/img/avatar/avatar-2.jpeg')); ?>" alt="message user image">
								<div class="direct-chat-text">
							...
							<div class="direct-chat-msg doted-border">
								...
								<img alt="iamgurdeeposahan" src="<?php echo e(asset('assets/img/avatar/avatar-3.jpeg')); ?>" class="direct-chat-img"><!-- /.direct-chat-img -->
								<div class="direct-chat-text">
		...
		<!--Horizontalmenu js-->
		<script src="<?php echo e(asset('assets/plugins/horizontal-menu/webslidemenu.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\durshal_cfp\ngo\resources\views/welcome.blade.php ENDPATH**/ ?>