                ...
                <div class="card-body">
					...
					<div class="container">
						...
						<?php if($later->aims->isNotEmpty()): ?>
								...
								<span><i><u><?php echo e($aim->name); ?></u></i>&nbsp;</span>
...
<hr>
					...
					<div class="row">
						<div class="col-12 text-center mt-3">
							<button id="reverse_btn_dg" class="btn btn-danger" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>"><i class="fa fa-reply" aria-hidden="true"></i>&nbsp;Reverse Application</button>
							<button id="approve_btn_dg" class="btn btn-primary" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Accept Application</button>
							<button id="reject_btn_dg" class="btn btn-danger" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>" data-user-id="<?php echo e(session('id')); ?>"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Reject Application</button>
					</div>
...
<?php endif; ?>
    ...
    $.ajax({
        url: "<?php echo e(route('forward.app.directorate')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
        success: function (response) {
            if (response.success) {
                Swal.fire({
                    ...
                    window.location.href = "<?php echo e(route('app_summary_directorate')); ?>";
                });
            } else {
                Swal.fire({
                    title: "Error!",
...
$("#reverse_btn_dg").click(function (e) {
    ...
    $.ajax({
        url: "<?php echo e(route('reverse.app.directorate')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
$("#reject_btn_dg").click(function (e) {
    ...
    $.ajax({
        url: "<?php echo e(route('reject.app.directorate')); ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
