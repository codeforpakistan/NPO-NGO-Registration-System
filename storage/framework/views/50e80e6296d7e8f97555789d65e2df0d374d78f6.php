...
<div class="app-content">
    ...
    <section class="section">
        ...
        <div class="page-header pt-0">
            <h4 class="page-title font-weight-bold">Summary</h4>
            <ol class="breadcrumb">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(url('application/')); ?>/<?php echo e($record->id); ?>"><button
                                                class="btn btn-sm btn-primary badge"
                                                data-target="#user-form-modal" data-toggle="modal"
                                                type="button">Move To Application</button></a>
                                    </td>
                                    </tr>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/LaravelAdminTemplete-main-2 3/resources/views/summary.blade.php ENDPATH**/ ?>