...
<hr>
					...
					<div class="row">
						<div class="col-12 text-center mt-3">
							<button id="reverse_btn_directorate" class="btn btn-danger" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>">Reverse Application</button>
							<button id="submit_btn_directorate" class="btn btn-primary" data-basic-info-id="<?php echo e($detail->basic_info_id); ?>">Accept Application</button>
					</div>
		...
		<script>
			$(document).ready(function () {
				$("#submit_btn_directorate").click(function () {
				...
				$("#reverse_btn_directorate").click(function () {
					var basicInfoId = $(this).data("basic-info-id");
